...
const Navbar = () => {
  return (
    ...
    //   </div>
    // </nav>
    <div className="relative grid grid-cols-[auto_1px_minmax(0,theme(maxWidth.3xl))_1px_auto] grid-rows-[1fr_1px_auto_1px_1fr] bg-background overflow-x-hidden no-scrollbar">
