...
const Footer = () => {
  return (
    <footer className="relative  w-full bg-background text-white py-20 overflow-hidden">
      <div className="absolute w-full h-[900px] bg-background rounded-full bottom-0 translate-y-[90%] border border-dashed border-ring z-20 shadow-2xl shadow-red-600" />
