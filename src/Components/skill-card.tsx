...
const Corner = ({ className }: { className?: string }) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    className={`absolute size-18 stroke-primary/80 z-50 ${className}`}
  >
...
export const SkillCard: React.FC<SkillCardProps> = ({
  ...
  return (
    <div className="relative w-60 h-40 bg-background border border-dashed border-ring/50 flex flex-col items-start justify-center gap-3 backdrop-blur-md px-4 overflow-hidden">
      ...
      <div className="flex items-center justify-start px-2 w-full">
        ...
        <DottedText text={title} dotSize={2} dotGap={0.5} />
      </div>
