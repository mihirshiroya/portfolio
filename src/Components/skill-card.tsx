...
export const SkillCard: React.FC<SkillCardProps> = ({
  ...
  return (
    <div onMouseEnter={() => setHoverKey((n) => n + 1)}
     className="relative w-full md:w-[230px] h-40 bg-background group border border-dashed border-ring/50 flex flex-col items-start justify-center gap-3 backdrop-blur-md px-4 overflow-hidden">
      ...
      <div className="h-2 mt-2 w-full">
        <Progress total={10} completed={completedValue} color={color}  parentHoverKey={hoverKey} />
      </div>
