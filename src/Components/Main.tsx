  ...
  return (
    <div>
      ...
      {/* Middle content container */}
            <Section>
            <div className="rounded-xl bg-background p-10 text-sm/7 text-primary w-full">
          ...
          <Section>
            <div className="rounded-xl bg-background p-10 text-sm/7 text-gray-700 dark:text-gray-300 w-full">
          <img src="/img/logo.svg" className="mb-11.5 h-6 dark:hidden" alt="Tailwind Play" />
          <img src="/img/logo-dark.svg" className="mb-11.5 h-6 not-dark:hidden" alt="Tailwind Play" />
          <div className="space-y-6">
            <p>An advanced online playground for Tailwind CSS, including support for things like:</p>
